...
<strong>$16.40 $20.50 </strong> <br> Bisi Farms
  ...
  style="height:300px; margin-top:30px; background:#333 url(images/carrot-kale-walnuts-tomatoes.jpg); background-size:cover;">
      <h1>SAVE 25% Off</h1>
 Be quick few products at this sale price
      </div>
 <div class="twelve _valorHeading">OFFER: 25% Off</div>
<div class="boxed" style="min-height:300px;">
